...
-- ==================================================
-- FLY TP (ដូច TeleportSystem ចាស់)
-- ==================================================
...
-- ==================================================
-- MAIN PROCESS (ដូច TeleportSystem ចាស់ — រង់ចាំ 60s)
-- ==================================================
VIPTP_StartProcess = function()
    ...
    -- ✅ Option: spawn or workspace (ដូច TeleportSystem ចាស់)
    ...
    elseif VIPTP_IsTargetInWorkspace() then
        ...
        -- ✅ រង់ចាំ 60s ដូច TeleportSystem ចាស់
        local WaitTime = 0
...
print("✅ VIPTP Loaded (AFK Farm Only | VIPTP_ Prefix | Instant | First Offset 5 | Safe Offset 5 | ForestStrike First Only | Logic ដូច TeleportSystem ចាស់)")
