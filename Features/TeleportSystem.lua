...
-- ✅ Auto Recovery (Egg Drop — No Shot TP)
-- ✅ Stop BodyV/G មុន TP (មិនកន្រាក់)
-- ✅ Safe Zone: Stop + Reset + Destroy
-- ✅ មិនពាក់ព័ន្ធនឹង FarmingManager
-- ==================================================
...
print("✅ TeleportSystem Loaded (Old + DropHeldEgg + Recovery + No Lag + No Callback)")
