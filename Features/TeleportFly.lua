...
print("[YOKUDO] TeleportFly: CollectEvent OK")
...
local function Enable()
    ...
    print("[YOKUDO] TeleportFly: ON")
end

local function Disable()
    FullReset()
    print("[YOKUDO] TeleportFly: OFF")
end

local function SetTargetId(Id)
    TARGET_UID = Id
    print("[YOKUDO] TeleportFly Target ID: " .. tostring(Id))
end
...
local function SetSpeed(Value)
    ...
    FLY_SPEED = Value
    RETURN_SPEED = Value
    print("[YOKUDO] TeleportFly Speed: " .. tostring(Value))
end
