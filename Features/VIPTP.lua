...
-- ==================================================
-- STOP ACTIVE HEARTBEAT (✅ ផ្លាស់ទីតាំងមកខាងលើ AutoStop)
-- ==================================================
...
local function VIPTP_AutoStop()
    ...
    VIPTP_StopActiveHeartbeat()  -- ✅ ឥឡូវដំណើរការ
    VIPTP_RestoreStats()
...
print("✅ VIPTP Loaded (AFK Farm Only | VIPTP_ Prefix | Instant | First Offset 5 | Safe Offset 50 | ForestStrike First Only | Fixed AutoStop)")
