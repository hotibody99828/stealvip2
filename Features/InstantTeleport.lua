...
print("[YOKUDO] InstantTeleport: CollectEvent OK")
...
local function Enable()
    ...
    print("[YOKUDO] InstantTeleport: ON")
end

local function Disable()
    FullReset()
    print("[YOKUDO] InstantTeleport: OFF")
end

local function SetTargetId(Id)
    TARGET_UID = Id
    print("[YOKUDO] InstantTeleport Target ID: " .. tostring(Id))
end
...
local function SetSpeed(Value)
    ...
    FLY_SPEED = Value
    RETURN_SPEED = Value
    print("[YOKUDO] InstantTeleport Speed: " .. tostring(Value))
end
